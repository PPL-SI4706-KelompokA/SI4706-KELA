...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/profile/update', function (\Illuminate\Http\Request $request) {
        $request->validate([
            ...
            'no_telp'     => 'required|string|max:20', // DIUBAH JADI REQUIRED
            'alamat'      => 'required|string|max:255', // DIUBAH JADI REQUIRED
        ...
        // Logika Penghapusan Foto Profil via Button "Hapus Foto"
        ...
        // Logika Penggantian Foto jika user mengunggah berkas baru
