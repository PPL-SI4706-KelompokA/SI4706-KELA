            ...
            <div class="bg-[#F0F1D9] p-8 lg:p-10 rounded-[40px] shadow-sm">
                ...
                <form action="<?php echo e(route('donasi.tambah')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="w-full bg-white/60 border-2 border-dashed border-gray-300 rounded-3xl p-8 flex flex-col items-center justify-center cursor-pointer hover:bg-white transition relative">
                            ...
                            <!-- Input file disembunyikan agar desain tetap rapi -->
                            <input type="file" name="foto_makanan" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
                        </div>
                    </div>
