...
<?php endif; ?>
    ...
    <script>
        ...
        const dbDonasi = <?php echo json_encode($donasis, 15, 512) ?>;
        ...
        function showDonationDetail(donasi) {
            ...
            btn.href = `<?php echo e(url('/donasi')); ?>/${donasi.id_donasi}/pesan`;
        }
...
</html><?php /**PATH C:\SI4706-KELA\resources\views/donasi/peta.blade.php ENDPATH**/ ?>