        ...
        <div class="bg-white rounded-[48px] overflow-hidden shadow-sm flex flex-col md:flex-row max-w-6xl mx-auto">
            ...
            <div class="md:w-5/12 p-8">
                <div class="relative rounded-[32px] overflow-hidden h-full min-h-[500px]">
                    <img src="<?php echo e($permintaan->donasi->foto_url ?? 'https://via.placeholder.com/600x800'); ?>" alt="Food" class="w-full h-full object-cover">
            ...
            <div class="md:w-7/12 p-12 flex flex-col justify-center">
                <h3 class="text-3xl font-extrabold text-gray-800 mb-8"><?php echo e($permintaan->donasi->nama_makanan ?? 'Nasi Goreng Spesial'); ?></h3>
                ...
                <div class="grid grid-cols-2 gap-y-6 gap-x-4 mb-10">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-gray-700"><?php echo e($permintaan->donasi->jumlah ?? '3'); ?> porsi tersedia</p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        <div class="w-10 h-10 rounded-full bg-[#F2F3E2] flex items-center justify-center mr-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-gray-700"><?php echo e($permintaan->donasi->tanggal_kadaluarsa ?? '11 Jan 2026'); ?></p>
                        </div>
                    </div>
                ...
                <div class="bg-[#F2F3E2] rounded-[32px] p-8 mb-10 relative">
                    ...
                    <div class="flex items-center mb-6">
                        <div class="w-14 h-14 rounded-full border-2 border-white overflow-hidden mr-4">
                            <img src="https://ui-avatars.com/api/?name=<?php echo e($permintaan->user->nama ?? 'Penerima'); ?>&background=FCD34D&color=5B5C35" class="w-full h-full object-cover">
                        </div>
                        <div>
                            <p class="text-lg font-bold text-gray-800"><?php echo e($permintaan->user->nama ?? 'Nama Tidak Diketahui'); ?></p>
                            <p class="text-xs font-semibold text-[#7C7E3A]">Meminta <?php echo e($permintaan->jumlah_permintaan ?? 1); ?> Porsi</p>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl p-4 mb-4 relative shadow-sm">
                        ...
                        <p class="text-sm font-medium italic text-gray-600">"<?php echo e($permintaan->catatan ?? 'Tidak ada catatan.'); ?>"</p>
                    </div>
                ...
                <!-- Action Buttons (FR07) -->
                <?php if(auth()->check() && auth()->user()->role === 'Donatur' && $permintaan->status === 'Pending'): ?>
                <div class="flex gap-4">
                    <form action="<?php echo e(route('permintaan.konfirmasi', $permintaan->id_permintaan)); ?>" method="POST" class="w-1/2">
                ...
                <?php else: ?>
                <div class="mt-4 p-4 rounded-2xl <?php echo e($permintaan->status == 'Disetujui' ? 'bg-green-50 text-green-700' : ($permintaan->status == 'Ditolak' ? 'bg-red-50 text-red-700' : 'bg-gray-50 text-gray-600')); ?> font-bold text-center">
                    Status Permintaan: <?php echo e($permintaan->status); ?>
...
</html><?php /**PATH C:\SI4706-KELA\resources\views/donasi/konfirmasi.blade.php ENDPATH**/ ?>