    ...
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col justify-between py-6 shrink-0">
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="<?php echo e(route('admin.laporan')); ?>" class="flex items-center px-8 py-3 bg-[#FCF8E3] text-[#6B630C] border-r-4 border-[#FCD34D] font-bold text-sm">
...
<?php endif; ?>
        ...
        <div class="px-10 py-2 flex-1">
            ...
            <div class="grid grid-cols-5 gap-8">
                ...
                <div class="col-span-2 bg-white rounded-[32px] p-8 relative overflow-hidden shadow-sm flex flex-col">
                    ...
                    <!-- Big Number -->
                    <h3 class="text-8xl font-extrabold text-gray-800 leading-none mb-5"><?php echo e(number_format($totalPenyaluran, 0, ',', '.')); ?></h3>
                    ...
                    <span class="inline-flex items-center px-4 py-2 bg-[#F0F4E8] text-[#6B630C] rounded-full text-xs font-bold w-fit">
                        ...
                        <?php echo e($growthText); ?> dari bulan lalu
                    </span>
                ...
                <div class="col-span-3 flex flex-col">
                    ...
                    <div class="space-y-3 flex-1">
                        <?php $__empty_1 = true; $__currentLoopData = $distribusiTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <div class="bg-white rounded-[20px] p-4 px-6 flex items-center shadow-sm border-l-4 <?php echo e($borderColor); ?>">
                            <div class="w-11 h-11 rounded-full flex items-center justify-center mr-4 text-xs font-extrabold shrink-0"
                                 style="background-color: <?php echo e($avatarBg); ?>; color: <?php echo e($textColor); ?>;">
                                <?php echo e($initials); ?>

                            </div>
                            <div class="flex-1">
                                <h4 class="font-bold text-gray-800 text-sm"><?php echo e($item->user->nama ?? 'Penerima'); ?></h4>
                                <p class="text-xs font-medium text-gray-400 mt-0.5">
                                    <?php echo e($item->donasi->nama_makanan ?? 'Makanan'); ?> •
                                    <span class="realtime-time" data-timestamp="<?php echo e($item->created_at->toIso8601String()); ?>"><?php echo e($item->created_at->diffForHumans()); ?></span>
                                </p>
                            </div>
                            <div class="text-right">
                                <h4 class="font-extrabold text-2xl text-gray-800"><?php echo e($item->jumlah_permintaan); ?></h4>
    ...
    <script>
        function downloadPdf() {
            ...
            let url = "<?php echo e(route('admin.laporan.print')); ?>";
            const params = [];
...
<?php /**PATH C:\SI4706-KELA\resources\views/admin/laporan.blade.php ENDPATH**/ ?>