            ...
            <form action="<?php echo e(route('rating.store', $donasi->id_donasi)); ?>" method="POST">
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="flex justify-center space-x-2" id="star-container">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <svg data-value="<?php echo e($i); ?>" class="star w-12 h-12 cursor-pointer transition-colors duration-200 <?php echo e($i <= 4 ? 'text-[#7C7E3A] fill-current' : 'text-gray-300 fill-current'); ?>" viewBox="0 0 24 24">
