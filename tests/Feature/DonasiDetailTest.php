...
class DonasiDetailTest extends TestCase
{
    ...
    public function test_history_icon_active_inactive_states(): void
    {
        ...
        $response->assertSee('class="flex items-center justify-center w-10 h-10 rounded-full transition-colors text-gray-500 hover:text-[#5B5C35]"', false);
        $response->assertDontSee('class="flex items-center justify-center w-10 h-10 rounded-full transition-colors text-[#FCD34D]"', false);
        ...
        $response->assertSee('class="flex items-center justify-center w-10 h-10 rounded-full transition-colors text-[#FCD34D]"', false);
        $response->assertDontSee('class="flex items-center justify-center w-10 h-10 rounded-full transition-colors text-gray-500 hover:text-[#5B5C35]"', false);
    }
    ...
    public function test_admin_layout_changes_and_export(): void
    {
        ...
        // Check sidebar cleanups: shouldn't see Export Data button, Support, but should see Sign Out
        ...
        // Check that the download button is NOT linked to export route (CSV export is removed)
        $response->assertDontSee(route('admin.laporan.export'));
