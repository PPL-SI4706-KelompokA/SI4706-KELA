            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-[32px] overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100 flex flex-col">
                    ...
                    <div class="p-6 flex-grow flex flex-col justify-between">
                        ...
                        <button onclick="openModal('{{ route('donasi.update-status', $item->id_donasi) }}', '{{ $item->status_donasi }}')" class="w-full py-3 bg-[#FCD34D] text-[#5B5C35] text-center font-bold text-sm rounded-2xl hover:bg-[#fbc316] transition-colors">
                            Ubah Status
                        </button>
                    </div>
                </div>
